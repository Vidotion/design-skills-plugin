...
### With React (see 3d-effekt-7 skill)

```javascript
// Three.js integrates naturally with React Three Fiber
// Use the 3d-effekt-7 skill for React integration patterns
```
...
For React integration, use the **3d-effekt-7** skill.
For animation, combine with the **scroll-animation-3** skill.
For UI animations, use the **animation4** skill.
