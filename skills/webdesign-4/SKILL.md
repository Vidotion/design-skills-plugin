...
- **animation4**: For understanding underlying animation concepts used by both libraries
- **scroll-animation-3**: Alternative approach for scroll-driven animations
- **animation3**: Alternative physics-based animation library
- **3d-effekt-4**: For 3D background effects as alternative to Particles/Plasma
