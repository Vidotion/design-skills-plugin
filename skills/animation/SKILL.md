---
name: animation
description: Page transitions library for creating fluid, smooth transitions between website pages. Use this skill when implementing page transitions, creating SPA-like experiences, adding animated route changes, or building websites with smooth navigation. Triggers on tasks involving Barba.js, page transitions, routing, view management, transition hooks, GSAP integration, or smooth page navigation. Works with scroll-animation-3 for transition animations.
---
...
**Reference scroll-animation-3 skill** for advanced GSAP integration patterns.
...
- **scroll-animation-3** - For advanced GSAP animations in transitions
- **scroll-animation-2** - Can be combined with Barba for smooth scrolling between pages
- **animation4** - Alternative approach for React-based page transitions
