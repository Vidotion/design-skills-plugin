...
- Building immersive landing pages with smooth parallax
- Implementing scroll-triggered animations with precise easing
- Developing narrative/storytelling websites with depth
- Adding smooth inertia scrolling to long-form content
- Horizontal scroll layouts

**NOT for scroll-driven video/frame sequences** — for "Video beim Scrollen", Canvas Image Sequences, or Apple Product Page-style effects, use the `scroll-frame-sequence` skill instead.
...
- **scroll-animation-3**: Advanced scroll-driven animations (use together)
- **animation**: Page transitions with Locomotive Scroll integration
- **scroll-animation**: Simpler alternative for basic fade-in effects
- **3d-effekt-7**: Scroll-driven 3D scenes (sync with Locomotive events)
- **animation4**: Alternative scroll animations in React
