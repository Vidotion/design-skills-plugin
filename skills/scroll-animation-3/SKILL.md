...
```javascript
import LocomotiveScroll from 'scroll-animation-2';
...
For Three.js-specific animations, also reference the **3d-effekt-4** skill.
For React components with built-in animations, reference the **animation4** skill.
