...
**Related Skills**: `scroll-animation-3`, `animation4`, `animation2` for optimized animations
...
**Related Skills**: `webdesign-4` for UI components
...
**Related Skills**: `animation4`, `animation3`, `animejs` for micro-interactions
...
**Related Skills**: `scroll-animation-3`, `scroll-animation-2`, `scroll-animation`, `3d-effekt-7` for 3D scrollytelling
...
**Related Skills**: `scroll-animation-3` (for easing), `animation4` (for React cursor components)
...
**Related Skills**: `webdesign-4` for glassmorphic components
...
**Technologies**:
- Background: Vanta.js WAVES effect (`3d-effekt-8`)
- Text animation: GSAP SplitText with stagger (`scroll-animation-3`)
- Button: Framer Motion hover states (`animation4`)
- Scroll indicator: CSS animation + GSAP fade out on scroll

**Related Skills**: `3d-effekt-8`, `scroll-animation-3`, `animation4`
...
**Related Skills**: `scroll-animation-3`, `scroll-animation-2`
...
**Related Skills**: `3d-effekt-7`, `3d-effekt-4`, `model-viewer-component`
...
**Related Skills**: `animation4`, `2d-effekt` for canvas-based visualizations
...
**Related Skills**: `animation`, `scroll-animation-3`, `animation4`
...
**Related Skills**: `scroll-animation-3`, `animation4`
...
**Related Skills**: `animation4`, `scroll-animation-3`, `scroll-animation`

## Integration with Other Skills

### Animation Skills Integration

**GSAP ScrollTrigger** (`scroll-animation-3`):
...
**Related Skills**: `3d-effekt-4`, `3d-effekt-7`, `3d-effekt-2`
...
**Related Skills**: `webdesign-4` for component patterns
...
- `scroll-animation-3` - Scroll-driven animations, pinning, scrubbing
- `animation4` - React animations, gestures, layout animations
- `animation3` - Physics-based animations
- `animejs` - SVG animations, stagger effects
- `animation2` - Designer-created animations
- `scroll-animation` - Simple scroll reveals (AOS)

### 3D & WebGL
- `3d-effekt-4` - Custom 3D scenes and effects
- `3d-effekt-7` - 3D in React applications
- `3d-effekt-2` - Physics-based 3D, VR/XR
- `3d-effekt-8` - Vanta.js backgrounds, Zdog illustrations

### Page Transitions & Scroll
- `animation` - Page transitions
- `scroll-animation-2` - Smooth scrolling

### Component Libraries
- `webdesign-4` - Magic UI, React Bits
- `2d-effekt` - Canvas-based 2D graphics
