...
- **3d-effekt-4**: For more complex 3D graphics beyond decorative effects
- **scroll-animation-3**: For animating these effects on scroll
- **animation4**: For React component animations alongside these effects
- **3d-effekt-7**: Advanced 3D when lightweight effects aren't enough
