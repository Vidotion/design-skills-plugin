...
This meta-skill provides architectural patterns, best practices, and integration strategies for combining multiple 3D and animation libraries in web applications. It synthesizes knowledge from the 3d-effekt-4, scroll-animation-3, 3d-effekt-7, animation4, and animation3 skills into cohesive patterns for building complex, performant 3D web experiences.
...
- **3d-effekt-4** - Three.js fundamentals, scene setup, rendering
- **scroll-animation-3** - GSAP animations, ScrollTrigger, timelines
- **3d-effekt-7** - R3F components, hooks, Drei helpers
- **animation4** - Motion components, gestures, layout animations
- **animation3** - Spring physics, React Spring hooks

**When to Reference Foundation Skills:**
- Three.js-specific API questions → `3d-effekt-4`
- ScrollTrigger syntax → `scroll-animation-3`
- R3F hooks and patterns → `3d-effekt-7`
- Motion gesture handling → `animation4`
- Spring configuration → `animation3`
