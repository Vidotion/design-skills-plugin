...
- **3d-effekt-4**: For 3D graphics; PixiJS can provide 2D UI overlays
- **scroll-animation-3**: For animating PixiJS properties with scroll
- **animation4**: For React component animations alongside PixiJS canvas
- **3d-effekt-7**: Similar React integration patterns
